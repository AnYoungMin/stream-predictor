...
from predictor.src.stream_pipeline.data_source import DataSource, AgentBasedDataSource
...
class AgentBasedDataSourceFactory(DataSourceFactory):
    ...
    def create_data_source(self, source_topic_name) -> DataSource:
        ...
        return AgentBasedDataSource(source_topic_name, self.agent_factory, source_pipe)
